...
class TestCanonicalContextAssignment:
    ...
    # Note: the old test that asserted root.right is a canonical sentinel
    # was removed in fix/canonical-hrf-sfreq (S4). Canonical HRFs are now
    # lazily generated by tree.get_canonical_hrf; tree.insert no longer
    # creates a sentinel sibling at root.right. Coverage for the new
    # behavior lives in tests/test_canonical_hrf.py.
